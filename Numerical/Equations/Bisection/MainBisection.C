...
int main(int argc, char *argv[]){
    ...
    if(help == 0){
        cout << "MainBisection -h | x_i x_s toler niter err_type" << endl;
        cout << "    x_i = lower bound of the interval (double)" << endl;
        cout << "    x_s = higher bound of the intarval (double)" << endl;
    ...
    bisection(x_i, x_s, toler, niter, err_type);
